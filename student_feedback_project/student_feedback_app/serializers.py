...
class Feedback_fullSerializer(serializers.ModelSerializer):
    class Meta:
        model = Feedback_full
        fields = ('image', 'iconId', 'feedback_id', 'points', 'datetime_given', 'optional_message', 'categoryColour', 'categoryName',
                  'preDefMessageText', 'studentName', 'courseName', 'fromUserName', 'studentColour')
