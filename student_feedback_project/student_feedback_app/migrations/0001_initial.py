# Generated by Django 2.1.3 on 2019-01-04 15:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_token', models.CharField(default='', max_length=7)),
            ],
        ),
        migrations.CreateModel(
            name='Feedback',
            fields=[
                ...
                ('which_class', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='student_feedback_app.Class')),
            ],
        ),
        migrations.CreateModel(
