...
urlpatterns = [
    ...
    re_path(r'^lecturer/(?P<lecturer_number>[\w\-]+)/my-provided-feedback/$', views.my_provided_feedback, name='my_provided_feedback'),
    re_path(r'^lecturer/create-class/$', views.create_class, name='create_class'),
    re_path(r'^lecturer/(?P<lecturer_number>[\w\-]+)/classes/$', views.lecturer_all_classes, name='lecturer_all_classes'),
